...
async function createProduct(reqData) {
  ...
  const product = new Product({
    ...
    brand: reqData.brand,
    price: reqData.price,
    sizes: reqData.size, // Use reqData.size instead of reqData.sizes
    ...
    additionalImages: reqData.additionalImages, // Use reqData.additionalImages instead of reqData.additionalImage
  });
